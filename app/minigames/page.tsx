    ...
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
          ...
          {games.map((game) => {
            ...
            return (
              <div key={game.id} className="relative">
                {game.available ? (
                  <div className="block p-6 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-xl border-2 border-gray-300 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all">
                    <div className="text-6xl mb-4">{game.emoji}</div>
                    <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">{game.title}</h2>
                  ...
                  <div className="p-6 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-xl border-2 border-gray-300 dark:border-gray-700 opacity-50">
                    <div className="text-6xl mb-4">{game.emoji}</div>
                    <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">{game.title}</h2>
                    <p className="text-gray-600 dark:text-gray-600 dark:text-gray-400">{game.description}</p>
                    <div className="mt-4 inline-block px-4 py-2 bg-gray-400 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg font-semibold">
                      Coming Soon
                    </div>
                  </div>
                )}
        ...
        <div className="mt-16">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-b-xl border-2 border-gray-300 dark:border-gray-700 border-t-0 overflow-hidden">
            {loadingLeaderboard ? (
              <div className="p-8 text-center text-gray-500 dark:text-gray-400">Loading leaderboard...</div>
            ) : leaderboard.length === 0 ? (
              <div className="p-12 text-center">
                <div className="text-6xl mb-4">🎯</div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">No completions yet today!</h3>
                <p className="text-gray-600 dark:text-gray-400">Be the first to complete today's HoopGrid and claim the top spot.</p>
              </div>
            ) : (
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-100 dark:bg-gray-900 border-b border-gray-300 dark:border-gray-700">
                      <tr>
                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Rank</th>
                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Player</th>
                        <th className="px-6 py-4 text-center text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Rarity Score</th>
                        <th className="px-6 py-4 text-center text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">Time</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-300 dark:divide-gray-700">
                      {leaderboard.slice(0, 10).map((entry) => {
                        ...
                        return (
                          <tr 
                            key={entry.userId} 
                            className={`${isCurrentUser ? 'bg-blue-100 dark:bg-blue-600/20 border-l-4 border-l-blue-500' : 'hover:bg-gray-100 dark:hover:bg-gray-700/50'} transition-colors`}
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center gap-3">
                                {entry.profilePicture ? (
                                  ...
                                  <div className="w-10 h-10 rounded-lg bg-gray-300 dark:bg-gray-700 flex items-center justify-center">
                            ...
                            <td className="px-6 py-4 text-center text-gray-700 dark:text-gray-300 hidden sm:table-cell">
            ...
            {leaderboard.length > 10 && (
              <div className="p-4 bg-gray-100 dark:bg-gray-900 text-center text-gray-600 dark:text-gray-400 text-sm border-t border-gray-300 dark:border-gray-700">
        ...
        {/* Info Section */}
        <div className="mt-16 p-8 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700">
