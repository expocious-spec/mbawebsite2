  ...
  try {
    ...
    const { data: newGameStats, error: insertError } = await supabaseAdmin
      ...
      .insert({
        ...
        offensive_rebounds: gameStats.offensiveRebounds || 0,
        defensive_rebounds: gameStats.defensiveRebounds || 0,
        assists: gameStats.assists,
        steals: gameStats.steals,
        blocks: gameStats.blocks || 0,
        turnovers: gameStats.turnovers,
        misses_forced: gameStats.missesForced || 0,
    ...
    const updatedStats = {
      ...
      blocks: allGameStats.reduce((sum, g) => sum + (g.blocks || 0), 0) / totalGames,
